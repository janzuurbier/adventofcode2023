// dag16-part2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	int max_aantal = 0;
	//the part below should for each edge (so 4 times with alterations)
	for (int r = 0; r < rows; r++) {
		history = matrix<set<dir_t>>(rows, cols, set<dir_t>());
		history[r][cols-1].insert(LEFT);
		beam_heads.push_back(beam_head(r, cols-1, LEFT));
